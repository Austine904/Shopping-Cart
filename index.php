...
<?php include 'connect.php';
    if(isset($_POST['add_product'])){
        ...
        $insert_query=mysqli_query($conn, "INSERT into products(product_id,name,price,quantity,image) values('$product_id','$product_name','$product_price','$product_quantity','$product_image')") or die("insert query failed");
    ...
    <div class="container">
     <section>
        ...
        <form action="" class="add_product" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="product_id" placeholder="Enter Product ID" class="input_fields" required>
            ...
            <input type="number" name="product_quantity" min= "0" placeholder="Enter Quantity" class="input_fields" required>
